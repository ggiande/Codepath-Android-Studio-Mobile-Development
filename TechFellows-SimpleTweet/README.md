# Simple Tweet 
Simple Tweet is a Twitter client that supports viewing a Twitter timeline.
...
* Getting [Tweet Timeline] (https://developer.twitter.com/en/docs/tweets/timelines/api-reference/get-statuses-home_timeline)
...
In order to be able to create a fully featured twitter client, the JSON will need to be parsed for the name of the user, handle of the user, along with their profile image, when the tweet was created, and the body of the tweet.
